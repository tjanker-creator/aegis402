// AEGIS402 — the payment carries its own proof of where the address came from.
//
...
console.log("AEGIS402 — the payment carries the proof of its own payee");
console.log(`guard ${GUARD} · registry ${REGISTRY} · one atomic group, submitted to a node\n`);
